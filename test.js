...
test("test getCodeAndUrls from search query inputs", async function (t) {
  var query = "quicksort";
  var language = "python";

  var response = await app.getCodeAndUrls(query, language);
  ...
  t.equal(actual, expected, "check results of getCodeAndUrls");
  t.end();
